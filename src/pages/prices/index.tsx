...
const Prices: React.FC = () => {
  ...
  return (
    <Layout>
      <Head>
        <title>Цены - SMART ACCOUNT AND CO</title>
        <meta name="description" content="Стоимость бухгалтерских услуг на аутсорсинге от ООО 'SMART ACCOUNT AND CO'" />
      </Head>

      {/* Hero Section */}
      <section className="pt-32 pb-20 bg-gradient-to-br from-primary to-blue-600 text-white relative overflow-hidden">
        <div className="absolute inset-0 bg-pattern opacity-10"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-blue-400 rounded-full filter blur-[120px] opacity-20"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl mb-8 text-blue-100" data-aos="fade-up" data-aos-delay="100">
              В ООО "SMART ACCOUNT AND CO" действует договорная система ценообразования. Стоимость услуг зависит от объема работы и особенностей вашего бизнеса.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div 
                ...
                className="border border-gray-200 rounded-2xl overflow-hidden hover:shadow-custom transition-all duration-300"
              >
                <div className="p-8">
          ...
          <div className="mt-20 max-w-3xl mx-auto text-center p-8 bg-gray-50 rounded-2xl shadow-custom" data-aos="fade-up">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link 
                href="/contact" 
                className="bg-primary hover:bg-primary/90 text-white px-8 py-4 rounded-lg font-semibold transition-colors inline-flex items-center justify-center"
              >
                Связаться с нами
              </Link>
              <Link 
                href="/calculator" 
                className="bg-white border border-primary text-primary hover:bg-primary/5 px-8 py-4 rounded-lg font-semibold transition-colors inline-flex items-center justify-center"
              >
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-custom" data-aos="fade-up" data-aos-delay="100">
            ...
            <div className="bg-white p-8 rounded-xl shadow-custom" data-aos="fade-up" data-aos-delay="200">
            ...
            <div className="bg-white p-8 rounded-xl shadow-custom" data-aos="fade-up" data-aos-delay="300">
            ...
            <div className="bg-white p-8 rounded-xl shadow-custom" data-aos="fade-up" data-aos-delay="400">
            ...
            <div className="bg-white p-8 rounded-xl shadow-custom" data-aos="fade-up" data-aos-delay="500">
            ...
            <div className="bg-white p-8 rounded-xl shadow-custom" data-aos="fade-up" data-aos-delay="600">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="bg-primary rounded-2xl p-12 text-center text-white relative overflow-hidden" data-aos="fade-up">
            <div className="absolute inset-0 bg-pattern opacity-10"></div>
            <div className="absolute bottom-0 right-0 w-64 h-64 bg-blue-400 rounded-full filter blur-3xl opacity-20"></div>
