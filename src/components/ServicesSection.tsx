...
export const services = [
  {
    ...
    fullDescription: `
      <p>ООО "SMART ACCOUNT AND CO" предлагает услуги полного ведения бухгалтерского учета для вашего бизнеса.</p>
  ...
  },
  {
    ...
    description: 'Профессиональные консультации по вопросам налогообложения и оптимизации',
    icon: <FiBarChart2 className="text-primary text-3xl" />,
    slug: 'nalogovoe-konsultirovanie',
    fullDescription: `
      <p>Наши эксперты предоставляют квалифицированные консультации по налогообложению:</p>
      <ul>
        <li>Анализ налоговых последствий сделок и операций</li>
        <li>Консультации по применению налогового законодательства</li>
        <li>Разработка схем налоговой оптимизации</li>
        <li>Оценка налоговых рисков</li>
        <li>Сопровождение налоговых проверок</li>
        <li>Подготовка ответов на запросы налоговых органов</li>
      </ul>
      <p>Грамотное налоговое планирование поможет вашему бизнесу работать эффективнее и безопаснее.</p>
    `
  }
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16" data-aos="fade-up">
          ...
          <p className="text-gray-600 text-lg">
            ООО "SMART ACCOUNT AND CO" предлагает комплексное обслуживание, которое позволит вам сосредоточиться на развитии бизнеса
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              <div 
                className="bg-white p-8 rounded-xl border border-gray-100 shadow-sm hover:shadow-custom hover:border-primary/20 transition-all duration-300 h-full flex flex-col"
                data-aos="fade-up"
